...
class BrainyUIInputText extends FlxSpriteGroup
{
	...
	public static var focusOn(default, set):BrainyUIInputText = null;
		...
		if(e.controlKey)
		{
			switch(flxKey)
			{
				...
				case V: //paste from clipboard
					...
					if(broadcastInputTextEvent) BrainyUIEventHandler.event(CHANGE_EVENT, this);
	...
	public static function set_focusOn(v:BrainyUIInputText)
	{
