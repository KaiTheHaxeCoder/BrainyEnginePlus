...
class BrainyUIRadioGroup extends FlxSpriteGroup
{
	...
	public var checkedRadio(default, set):BrainyUIRadioItem;
	...
	function set_checkedRadio(v:BrainyUIRadioItem)
	{
		checkedRadio = null;
	...
	{
		var radio:BrainyUIRadioItem = cast recycle(BrainyUIRadioItem);
		radio.onClick = function() {
			checkedRadio = radio;
			if(onClick != null) onClick();
			if(broadcastRadioGroupEvent) BrainyUIEventHandler.event(CLICK_EVENT, this);
		};
...
class BrainyUIRadioItem extends BrainyUICheckBox
{
